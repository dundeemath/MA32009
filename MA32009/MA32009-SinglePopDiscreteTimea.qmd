...
In Figure @fig-plotdensmodelharveststab we plot the contours of the hypersurface  $H'(N^*)$ at the critical values of $-1$, $0$ and 1. Note that the points in parameter space used to generate the simulation results in @fig-plotdensmodelharvest are $(h,\gamma)=(0.1,5)$ $(h,\gamma)=(1,5)$ and $(h,\gamma)=(3,5)$. 
Cobweb diagrams in different regions of parameter space are presented in @fig-densharvestingmodelcobweb.
